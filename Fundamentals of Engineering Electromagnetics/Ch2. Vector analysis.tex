...
(\nabla \times \vec{A})_u = \hat{a_u} \cdot (\nabla \times \vec{A}) = \lim_{\Delta S_u \to 0} \frac{1}{\Delta S_u} (\oint_{C_u} \vec {A} \cdot \text{d} \vec{l})
$$
For $(\nabla \times \vec{A})$ in Cartiesian coordinates, the differential rectangular area is below.
...
%Straight Lines [id:da07173645514972404] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (281.35,162.65) -- (279.67,231) ;
%Straight Lines [id:da6326497744935679] 
\draw    (196.33,185.67) -- (166.74,209.5) -- (146.56,225.75) ;
\draw [shift={(145,227)}, rotate = 321.16] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da0789696871834551] 
\draw    (196.33,185.67) -- (307.75,205.18) -- (339.03,210.66) ;
\draw [shift={(341,211)}, rotate = 189.93] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da8339732982001292] 
\draw    (196.33,185.67) -- (195.68,99.67) ;
\draw [shift={(195.67,97.67)}, rotate = 89.57] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da07535116275948683] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (166.74,209.5) -- (279.67,231) ;
%Straight Lines [id:da22891962776065966] 
\draw  [dash pattern={on 4.5pt off 4.5pt}]  (307.75,205.18) -- (279.67,231) ;
%Flowchart: Process [id:dp46456426694433717] 
\draw  [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ][fill={rgb, 255:red, 74; green, 144; blue, 226 }  ,fill opacity=0.39 ] (259.08,141.84) -- (304.97,149.11) -- (303.63,183.47) -- (257.73,176.19) -- cycle ;
%Straight Lines [id:da03910636666006706] 
\draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (282.17,145.58) -- (286.67,143.08) ;
%Straight Lines [id:da7511400679910567] 
\draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (286,149.08) -- (282.17,145.58) ;
%Straight Lines [id:da0508381960589791] 
\draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (306.33,171.92) -- (304.17,168.25) ;
%Straight Lines [id:da440029181301571] 
\draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (304.17,168.25) -- (301.5,171.42) ;
%Straight Lines [id:da8256107974831526] 
\draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (276.62,179.07) -- (273.96,176.07) ;
%Straight Lines [id:da767646697347278] 
\draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (273.35,181.87) -- (276.52,179.71) ;
%Straight Lines [id:da4494212263565157] 
\draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (258.17,160.42) -- (255.83,157.08) ;
%Straight Lines [id:da7462615231725471] 
\draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (260.5,158.25) -- (258.17,160.42) ;
%Straight Lines [id:da6241975086374123] 
\draw    (281.35,162.65) -- (262.95,173.03) ;
\draw [shift={(260.33,174.5)}, rotate = 330.6] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
%Shape: Circle [id:dp7229223348289022] 
\draw  [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] (280.03,162.65) .. controls (280.03,161.92) and (280.62,161.33) .. (281.35,161.33) .. controls (282.08,161.33) and (282.67,161.92) .. (282.67,162.65) .. controls (282.67,163.38) and (282.08,163.97) .. (281.35,163.97) .. controls (280.62,163.97) and (280.03,163.38) .. (280.03,162.65) -- cycle ;
%Straight Lines [id:da2526213850742248] 
\draw    (259.2,139.9) -- (260,121.9) ;
%Straight Lines [id:da7124781381730358] 
\draw    (265.18,125.57) -- (301.22,130.03) ;
\draw [shift={(304.2,130.4)}, rotate = 187.06] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (3.57,-1.72) -- (0,0) -- (3.57,1.72) -- cycle    ;
\draw [shift={(262.2,125.2)}, rotate = 7.06] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (3.57,-1.72) -- (0,0) -- (3.57,1.72) -- cycle    ;
%Straight Lines [id:da26957244315102435] 
\draw    (305.2,146.1) -- (306.2,126.1) ;
%Straight Lines [id:da2786844142809314] 
\draw    (253.73,175.36) -- (233.03,172.01) ;
%Straight Lines [id:da5076632123594157] 
\draw    (239.53,168.37) -- (240.95,143.34) ;
\draw [shift={(241.12,140.34)}, rotate = 93.24] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (3.57,-1.72) -- (0,0) -- (3.57,1.72) -- cycle    ;
\draw [shift={(239.36,171.36)}, rotate = 273.24] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (3.57,-1.72) -- (0,0) -- (3.57,1.72) -- cycle    ;
%Straight Lines [id:da5354624915318639] 
\draw    (255.73,141.36) -- (236.82,138.27) ;
%Curve Lines [id:da6836709006288629] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (281.35,162.65) .. controls (289.5,154.88) and (298.75,148.88) .. (324,153.13) ;

% Text Node
\draw  [draw opacity=0][fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ]  (276.2,120.6) -- (293.2,120.6) -- (293.2,133.6) -- (276.2,133.6) -- cycle  ;
\draw (279.2,125) node [anchor=north west][inner sep=0.75pt]  [font=\tiny]  {$\Delta y$};
% Text Node
\draw  [draw opacity=0][fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ]  (231.36,148.45) -- (248.36,148.45) -- (248.36,161.45) -- (231.36,161.45) -- cycle  ;
\draw (234.36,152.85) node [anchor=north west][inner sep=0.75pt]  [font=\tiny]  {$\Delta z$};
% Text Node
\draw (308,164.71) node [anchor=north west][inner sep=0.75pt]  [font=\tiny] [align=left] {1};
% Text Node
\draw (281.14,137) node [anchor=north west][inner sep=0.75pt]  [font=\tiny] [align=left] {2};
% Text Node
\draw (250,156.43) node [anchor=north west][inner sep=0.75pt]  [font=\tiny] [align=left] {3};
% Text Node
\draw (273.56,182.74) node [anchor=north west][inner sep=0.75pt]  [font=\tiny] [align=left] {4};
% Text Node
\draw (329.92,152.07) node [anchor=north west][inner sep=0.75pt]  [font=\tiny,color={rgb, 255:red, 74; green, 144; blue, 226 }  ,opacity=1 ]  {$P( x_{0} ,\ y_{0} ,\ z_{0})$};
% Text Node
\draw (135.33,223.73) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize]  {$x$};
% Text Node
\draw (342,204.4) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize]  {$y$};
% Text Node
\draw (192,83.07) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize]  {$z$};
% Text Node
\draw (193,189.07) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize]  {$O$};
\end{tikzpicture}
\end{center}

\begin{align*}
	&\hat{a_u} = \hat{a_x}, \Delta S_u = \Delta y \Delta z, C_u \text{four sides 1,2,3,4} \\
	&(\nabla \times \vec{A}) = \hat{a_x} \cdot (\nabla \times \vec{A}) = \lim_{\Delta y \Delta z \to 0} \frac{1}{\Delta y \Delta z} (\oint_{\substack{Sides \\ 1,2,3,4}} \vec{A} \cdot \text{d} \vec{l}) \\ 
	&\vec{A} = \hat{a_x}A_x + \hat{a_y}A_y + \hat{a_z}A_z
\end{align*}

\textbf{For side1}: $\text{d} \vec{l} = \hat{a_z} \Delta z$, \quad $A_z(x_0, y_0 + \frac{\Delta y}{2}, z_0)$ \\
$$
...
\subsection*{Identity \romannumeral2}
...
$$
  \nabla \times \vec{F} = \begin{vmatrix}
		...
		\frac{\partial}{\partial x} & \frac{\partial}{\partial y} & \frac{\partial}{\partial z} \\ 
		xy & -2x & 0
	\end{vmatrix} = \hat{a_z} (-x-2) = - \hat{a_z} (x+2)
$$
Since $\text{d} \vec{s} = \hat{a_n} s = \hat{a_z} \text{d}x \text{d}y$, and $x^2 + y^2 = 9$; therefore,
